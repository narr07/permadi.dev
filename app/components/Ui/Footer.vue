  ...
  >
    ...
    <div class="text-center">
      ...
      <div class="mt-3 space-x-2">
        <a
          class="focus:outline-hidden inline-flex size-8 items-center justify-center gap-x-2 rounded-full border border-transparent text-sm font-semibold text-gray-500 hover:bg-gray-50 focus:bg-gray-50 disabled:pointer-events-none disabled:opacity-50"
          href="#"
        >
          <svg
