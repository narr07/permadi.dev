...
<template>
  <svg
    id="Layer_1" :height="height" :width="width" version="1.1" xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    <g>
      <g>
        <path
          style="fill: #014744" d="M250.3,0.1c-138.1,0-250,111.9-250,250s111.9,250,250,250s250-111.9,250-250S388.4,0.1,250.3,0.1z
    ...
    <g>
      <path
        style="fill: #014744" d="M356.6,250.1c0,12.5-10.1,22.5-22.5,22.5c-12.4,0-22.5-10.1-22.5-22.5c0-12.5,10.1-22.5,22.5-22.5
C346.5,227.6,356.6,237.6,356.6,250.1z"
      />
    </g>
    <g>
      <path
        style="fill: #014744" d="M189.3,250.1c0,12.5-10.1,22.5-22.5,22.5s-22.5-10.1-22.5-22.5c0-12.5,10.1-22.5,22.5-22.5
